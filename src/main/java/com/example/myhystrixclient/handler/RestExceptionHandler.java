...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleFrameworkValidationError(FrameworkValidationError ex, WebRequest request) {
		...
		validationResponse.setAddMoredetails("Exception generated by myhystrixclient");
	...
	protected ResponseEntity<Object> handleExceptionInternal(Exception ex, Object body, HttpHeaders headers,
		...
		LOGGER.info("Exception occurred for req[" + request + "]   exception: " + ex.toString(), ex);
		...
		if (body instanceof ValidationResponse) {
			...
			LOGGER.info("ValidationResponse ErrorResponse: HttpStatus[" + validationResponse.getStatus() + "]  code["
